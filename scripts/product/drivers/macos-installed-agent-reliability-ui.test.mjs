...
test("reliability recording sources stay within focused line guards", () => {
  for (const [path, limit] of [
    ...
    ["scripts/product/drivers/macos-installed-agent-reliability-ui.mjs", 240], ["scripts/product/drivers/macos-installed-agent-ui-wait.mjs", 40],
    ["scripts/product/drivers/macos-installed-agent-reliability-run.mjs", 240], ["scripts/product/drivers/macos-installed-agent-completion.test.mjs", 45], ["scripts/product/drivers/macos-installed-agent-state.test.mjs", 55], ["scripts/product/drivers/macos-installed-agent-ui-wait.test.mjs", 45], ["scripts/product/drivers/reliability-run-collector.mjs", 65], ["scripts/product/drivers/reliability-run-collector.test.mjs", 105],
