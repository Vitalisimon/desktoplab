...
test("macOS packaged launch path boots setup-first shell with protected local API", async ({
  page,
  request,
}, testInfo) => {
  test.skip(testInfo.project.name !== "desktop", "macOS packaged launch smoke mutates shared local API state");
